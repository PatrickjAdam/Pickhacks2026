...
export const appStyles = {
  ...
  title: { margin: 0, fontSize: "4rem", color: "#717744", fontWeight: 700, letterSpacing: "-0.03em", font: "serif" },
  ...
  searchBtn: { background: "#717744", border: "none", borderRadius: "8px", padding: "0.6rem 1.2rem", color: "#fff", fontWeight: 700, cursor: "pointer", fontSize: "0.9rem" },
  ...
  missingTitle: { margin: "0 0 0.4rem", fontSize: "0.75rem", color: "#717744" },
  ...
  // Map area
  mapContainer: { flex: 1, position: "relative",background: "#0d0d14", },
  ...
  //AI overviw box
  // AI summary box
  aiBox: { padding: "1rem", borderBottom: "1px solid #1a1a2a" },
  aiHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.6rem" },
  aiTitle: { fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em", color: "#717744", fontWeight: 700 },
  aiRefresh: { background: "none", border: "none", color: "#555", cursor: "pointer", fontSize: "1rem", padding: "0 0.2rem", lineHeight: 1 },
  aiText: { margin: 0, fontSize: "0.82rem", lineHeight: 1.7, color: "#bbb" },
  aiLoading: { display: "flex", gap: "0.3rem", alignItems: "center", padding: "0.5rem 0" },
  aiDot: { display: "inline-block", width: 6, height: 6, borderRadius: "50%", background: "#717744" },
};
